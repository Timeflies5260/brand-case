        ...
        <table>
            ...
            <tr>
                ...
                <td class="inputs">
                    ...
                    <span id="username_err" class="err_msg" style="display: none">用户名已存在</span><br>
...
<script>
    setTimeout("document.getElementById(\"register_err\").style.display = 'none'",3000);
    ...
    function myFunction() {
        ...
        //2.2. 发送请求
        xhttp.open("GET", "http://localhost:8080/brand-case/examServlet?username="+username,true);
        xhttp.send();
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                //判断
                if(this.responseText=="havenUser"){
                    //用户名存在，显示提示信息
                    document.getElementById("username_err").style.display ='';

                    setTimeout("document.getElementById(\"username_err\").style.display = 'none'",3000);
                }else {
                    //用户名不存在 ，清除提示信息
